    ...
    <main>
      <section className="section founder-page">
        <motion.div className="founder-story" {...fade}>
          ...
          <p>AX1 was not built from a product idea. It came from a problem I kept running into across capital and execution.</p>
