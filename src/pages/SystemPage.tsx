...
const capabilities = [
  ...
  { icon: FileCheck2, title: 'Attributable evidence', copy: 'Keep material evidence connected to its source, responsible actor and present review position.' },
  ...
  return (
    <main className="cg-public-page cg-system-page">
      <section className="cg-public-hero" aria-labelledby="system-title">
        <div className="cg-shell cg-public-hero-grid">
          <motion.div {...fade}>
            ...
            <p>Axis One connects execution, attributable evidence, ownership and human authority in one governed programme context. It makes the current decision basis visible while configured governance remains private.</p>
      ...
      <section className="cg-public-section is-light" aria-labelledby="system-context-title"><div className="cg-shell">
        <motion.header className="cg-section-heading" {...fade}><span className="cg-eyebrow">One governed context</span><h2 id="system-context-title">Connect the decision to what is happening now.</h2><p>Axis One keeps the material basis for the next action visible as execution changes.</p></motion.header>
      ...
      <section className="cg-public-section is-dark" aria-labelledby="system-shift-title"><div className="cg-shell">
        <motion.header className="cg-section-heading cg-section-heading-dark" {...fade}><span className="cg-eyebrow">The operating shift</span><h2 id="system-shift-title">From reconstructed evidence to governed decision readiness.</h2><p>The difference is not more information. It is whether current execution, evidence and authority remain connected when action is required.</p></motion.header>
      ...
      <section className="cg-public-section is-light" aria-labelledby="system-boundary-title"><div className="cg-shell cg-public-editorial-split">
        <motion.div {...fade}><span className="cg-eyebrow">Protected operating model</span><h2 id="system-boundary-title">Decision clarity with configured governance kept private.</h2><p>Clients can see the context needed for action while their configured rules and governance design remain private.</p></motion.div>
        <motion.div className="cg-public-editorial-copy cg-system-boundary-copy" {...fade}><p>The present decision position remains understandable while client rules, thresholds and governance design stay private.</p><ul><li><ShieldCheck size={16} />Current execution and evidence position</li><li><ShieldCheck size={16} />Visible ownership and responsible authority</li><li><ShieldCheck size={16} />Clear decision readiness and permitted direction</li><li><ShieldCheck size={16} />Private client rules, thresholds and configuration</li></ul></motion.div>
      </div></section>

      <section className="cg-public-cta"><div className="cg-shell"><div><span>Start with one approaching decision</span><h2>See whether its basis is current, attributable and actionable.</h2></div><a className="cg-button cg-button-primary" href="/#decision-brief" onClick={() => trackAX1Event('primary_cta_selected', { location: 'system_footer', action: 'decision_brief' })}>Prepare a Decision Brief<ArrowRight size={16} /></a></div></section>
