  ...
  return (
    <main className="cg-public-page cg-trust-page">
      <section className="cg-public-hero" aria-labelledby="trust-title">
        <div className="cg-shell cg-public-hero-grid">
          <motion.div {...fade}>
            ...
            <h1 id="trust-title">Know what <span className="cg-public-keep">Axis One</span> does, and where it stops.</h1>
            <p>Institutional trust depends on explicit authority, attributable evidence, scoped access and honest product boundaries. Axis One is designed to make each one visible.</p>
      ...
      <section className="cg-public-section is-light" id="trust-boundaries" aria-labelledby="trust-boundaries-title"><div className="cg-shell">
        <motion.header className="cg-section-heading" {...fade}><span className="cg-eyebrow">Claims and boundaries</span><h2 id="trust-boundaries-title">Every trust claim should say what it does not mean.</h2><p>This is the public operating boundary of Axis One capital governance infrastructure.</p></motion.header>
      ...
      <section className="cg-public-section is-dark" aria-labelledby="not-ax1-title"><div className="cg-shell cg-public-split">
        <motion.div {...fade}><span className="cg-eyebrow">What Axis One is not</span><h2 id="not-ax1-title">Clear boundaries protect the decision.</h2><p>Axis One supports governed context and progression. Responsibility remains with the authorised organisations and people.</p></motion.div>
